...
function Education({ position, company, location, duration }) {
  return (
    <article className="glass-card rounded-2xl p-6 relative overflow-hidden group">
      {/* Left accent bar */}
      <div className="absolute left-0 top-0 bottom-0 w-1 rounded-l-2xl bg-gradient-to-b from-violet-500 via-pink-500 to-transparent" />
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1.5 text-slate-500 text-sm mt-1">
            <svg width="12" height="12" viewBox="0 0 16 14" fill="currentColor" className="flex-shrink-0">
        ...
        {/* Duration */}
        <div className="flex items-center gap-1.5 text-slate-500 text-xs mt-2 sm:mt-0 sm:ml-4 flex-shrink-0">
